  ...
  return (
    <Link to={'/course/'+ course._id} onClick={()=>scrollTo(0,0)} className='border border-gray-500/30 pb-6 overflow-hidden rounded-lg'>
        ...
        <div className='p-3 text-left'>
            ...
            <p className='text-gray-500'>Marverick</p>
            ...
            <p className='text-base font-semibold text-grey-800'>{currency}{(course.coursePrice- course.discount * course.coursePrice /100).toFixed(2)}</p>
        </div>
